...
{/block}
{block name=title}<title> Listado Tipo Clientes</title>{/block}
{block name=content}
    ...
    <table class="table table-condensed">
        <caption class="text-center">Tipo de Clientes</caption>
        <thead>
            <tr>
                <th>ID</th>
                <th>DESCRIPCION</th>
        ...
        <tr>
            ...
            <td>
                <a href="{router nombreRuta="$routerPrefix.edit" parametros=['id'=>$item->id_tipo]}"
                 class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
                <form style="display:inline"
                    action="{router nombreRuta="$routerPrefix.delete" parametros=['id'=>$item->id_tipo]}"
