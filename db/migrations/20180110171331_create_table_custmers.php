...
class CreateTableCustmers extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
          $cliente = $this->table('cliente', ['id' => false, 'primary_key' => ['id_cliente']]);
        $cliente->addColumn('id_cliente', 'integer')
              ->addColumn('razon_social', 'string', ['null' => true])
